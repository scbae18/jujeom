 ...
 * @typedef {{ id: number, name: string, price: number, category: string, description?: string, addonOnly?: boolean, friendService?: boolean, hideFirstOrderBadge?: boolean, kitchenParts?: string[] }} MenuItem
